...
moduleForModel('i-i-s-avtomatizaciya-zakupok7-склады', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok7-склады', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok7-склады',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
