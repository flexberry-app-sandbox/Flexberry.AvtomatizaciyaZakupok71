...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok7 отчет о зак l');

test('testing i-i-s-avtomatizaciya-zakupok7-отчет-о-зак-l', function(assert) {
