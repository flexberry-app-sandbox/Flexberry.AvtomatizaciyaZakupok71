...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok7 номенклатура l');

test('testing i-i-s-avtomatizaciya-zakupok7-номенклатура-l', function(assert) {
