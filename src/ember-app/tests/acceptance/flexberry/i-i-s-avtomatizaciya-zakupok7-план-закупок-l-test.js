...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok7 план закупок l');

test('testing i-i-s-avtomatizaciya-zakupok7-план-закупок-l', function(assert) {
