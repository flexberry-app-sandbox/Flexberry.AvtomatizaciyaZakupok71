...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok7 контрагенты l');

test('testing i-i-s-avtomatizaciya-zakupok7-контрагенты-l', function(assert) {
