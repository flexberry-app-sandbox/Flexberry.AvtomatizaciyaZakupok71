...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok7 единицы измер l');

test('testing i-i-s-avtomatizaciya-zakupok7-единицы-измер-l', function(assert) {
