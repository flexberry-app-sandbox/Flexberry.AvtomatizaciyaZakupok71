...
namespace IIS.Avtomatizaciya_zakupok7
{
    ...
    [View("ТЧЗаказE", new string[] {
            ...
            "Номенклатура.ЕдиницыИзмер.ЕдиницаИзмер as \'ЕдиницаИзмер\'"}, Hidden=new string[] {
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupok7.ЗаказПост fЗаказПост;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Avtomatizaciya_zakupok7.ЗаказПост.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ЗаказПост"})]
        public virtual IIS.Avtomatizaciya_zakupok7.ЗаказПост ЗаказПост
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupok7.ЗаказПост result = this.fЗаказПост;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Avtomatizaciya_zakupok7.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Avtomatizaciya_zakupok7.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Avtomatizaciya_zakupok7.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Avtomatizaciya_zakupok7.ЗаказПост fЗаказПост) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fЗаказПост)))
        {
        }
        
        public IIS.Avtomatizaciya_zakupok7.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Avtomatizaciya_zakupok7.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Avtomatizaciya_zakupok7.ТЧЗаказ dataobject)
        {
