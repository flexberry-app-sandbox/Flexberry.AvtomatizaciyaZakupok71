...
namespace IIS.Avtomatizaciya_zakupok7
{
    ...
    public class ПланЗакупок : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupok7.DetailArrayOfПлан fплан;
        ...
        public virtual IIS.Avtomatizaciya_zakupok7.DetailArrayOfПлан план
        {
            get
            {
                ...
                if ((this.fплан == null))
                {
                    this.fплан = new IIS.Avtomatizaciya_zakupok7.DetailArrayOfПлан(this);
                }
                IIS.Avtomatizaciya_zakupok7.DetailArrayOfПлан result = this.fплан;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокE", typeof(IIS.Avtomatizaciya_zakupok7.ПланЗакупок));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокL", typeof(IIS.Avtomatizaciya_zakupok7.ПланЗакупок));
                }
            }
        }
    }
