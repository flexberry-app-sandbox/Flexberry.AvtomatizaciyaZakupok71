...
CREATE INDEX Index83a28cd0773d73ef37c6d2c02431e2b1fdf21639 on ОтчетОЗак (Контрагенты); 
 ...
 ALTER TABLE ТчОтчет ADD CONSTRAINT FK5b2d3c2d5c240025487d7e8328cbaf8ea5a09d88 FOREIGN KEY (Номенклатура) REFERENCES Номенклатура; 
CREATE INDEX Index5b2d3c2d5c240025487d7e8328cbaf8ea5a09d88 on ТчОтчет (Номенклатура); 

 ALTER TABLE ТчОтчет ADD CONSTRAINT FK83927a502696331cb31ff3919525d4eaf2872a91 FOREIGN KEY (ОтчетОЗак_m0) REFERENCES ЗаказПост; 
CREATE INDEX Index83927a502696331cb31ff3919525d4eaf2872a91 on ТчОтчет (ОтчетОЗак_m0); 

 ALTER TABLE ТчОтчет ADD CONSTRAINT FK20e80ade896026f9734882c2e368a3e6b6aee73b FOREIGN KEY (ОтчетОЗак_m1) REFERENCES ОтчетОЗак; 
CREATE INDEX Index20e80ade896026f9734882c2e368a3e6b6aee73b on ТчОтчет (ОтчетОЗак_m1); 
